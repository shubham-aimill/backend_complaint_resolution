...
"[project]/app/api/claims/[claimId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiUrl"])(`api/complaints/${encodedClaimId}`), {
            method: 'GET',
            headers: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$normalizeClaim$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeClaimResponse"])(claim));
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06a17606._.js.map