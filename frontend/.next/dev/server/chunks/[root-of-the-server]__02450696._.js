...
"[project]/lib/auth/csvAuth.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CSV_IN_ROOT = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(PROJECT_ROOT, 'login_credentials.csv');
const CSV_IN_CWD = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'login_credentials.csv');
function getCsvPath() {
    if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(CSV_IN_ROOT)) return CSV_IN_ROOT;
    if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(CSV_IN_CWD)) return CSV_IN_CWD;
    return CSV_IN_ROOT;
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$csvAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth/csvAuth.ts [app-route] (ecmascript)");
;
;
async function POST(request) {
    try {
        ...
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$csvAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateCredentials"])(email, password);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02450696._.js.map