...
"[project]/app/api/claims/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiUrl"])('api/complaints?includeDeskRejected=true'), {
            method: 'GET',
            headers: {
        ...
        const summaries = Array.isArray(raw) ? raw.map((s)=>({
                ...s,
                claimId: s.claimId ?? s.complaintId,
                ingestedClaimId: s.ingestedClaimId ?? s.ingestedComplaintId,
                claimantName: s.claimantName ?? s.customerName,
                policyNumber: s.policyNumber ?? s.customerRef
            })) : [];
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(summaries);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        // Proxy to FastAPI server (backend uses complaints)
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiUrl"])('api/complaints'), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__53fa51df._.js.map