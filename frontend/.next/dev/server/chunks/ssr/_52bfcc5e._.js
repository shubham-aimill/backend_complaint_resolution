module.exports = [
"[project]/lib/clientCache.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/emailDisplay.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    ...
    ()=>formatEmailBodyForDisplay,
    "stripEmbeddedMailHeaders",
    ()=>stripEmbeddedMailHeaders
]);
function cleanQuotedLines(body) {
    return body.split('\n').map((l)=>l.replace(/^>+\s?/, '')).join('\n').trim();
}
function stripEmbeddedMailHeaders(body) {
...
function formatEmailBodyForDisplay(body) {
    return cleanQuotedLines(stripEmbeddedMailHeaders(body));
}
}),
"[project]/lib/confidence.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/normalizeClaim.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeClaimResponse(data) {
    ...
    const crmNameFromGrounding = policyGrounding[0]?.customer_name;
    const crmNameFromInfo = policyHolderInfo?.full_name ?? dp.customerInfo?.full_name;
    const reconciledName = (crmNameFromGrounding || crmNameFromInfo || '').trim() || undefined;
    const claimDraftReconciled = reconciledName ? {
        ...claimDraft,
        claimantName: reconciledName,
        customerName: reconciledName
    } : claimDraft;
...
"[project]/lib/hooks/useMailChain.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMailChain(ingestedId) {
    const [chain, setChain] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
...
"[project]/lib/hooks/useComplaintDecision.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useComplaintDecision(claimData, ingestedId) {
    ...
    const decide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (params)=>{
        setLoading(true);
        setError(null);
        try {
...
"[project]/lib/hooks/useAppointment.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAppointment() {
    ...
    const book = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (params)=>{
        setLoading(true);
        setError(null);
        try {
...
"[project]/lib/hooks/useEmailDraft.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useEmailDraft(onSent) {
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const open = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((type, body, recipient, subject, inReplyTo, references)=>{
        setDraft({
            type,
            body,
            recipient,
    ...
    const updateBody = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((body)=>{
        setDraft((prev)=>prev ? {
                ...prev,
                body
            } : prev);
    }, []);
    const updateRecipient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((recipient)=>{
        setDraft((prev)=>prev ? {
                ...prev,
                recipient
            } : prev);
    }, []);
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!draft) return;
        setSending(true);
        setError(null);
        try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ReviewPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ReviewPage.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DecisionPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DecisionPage.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DashboardPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DashboardPage.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$FAQPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/FAQPage.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth/AuthContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientCache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/clientCache.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function Home() {
    ...
    const { isAuthenticated, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const [currentStage, setCurrentStage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('home');
    const [claimData, setClaimData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleViewResolved = async (claimId, stage)=>{
        ...
        const cached = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientCache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCached"])(cacheKey);
        if (cached) {
            setClaimData(cached);
            setCurrentStage(stage);
        ...
        try {
            ...
            if (res.ok) {
                const data = await res.json();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clientCache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCached"])(cacheKey, data, ttlMs);
        ...
        switch(currentStage){
            ...
            case 'review':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ReviewPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        claimData: claimData,
            ...
            case 'decision':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container mx-auto px-4 py-8",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DecisionPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        claimData: claimData,
            ...
            case 'faq':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$FAQPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                    fileName: "[project]/app/page.tsx",
                    lineNumber: 152,
                    columnNumber: 16
                }, this);
...
//# sourceMappingURL=_52bfcc5e._.js.map